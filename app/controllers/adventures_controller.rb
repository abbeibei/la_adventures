class AdventuresController < ApplicationController
  ...
  private
    ...
    def adventure_params
      params.require(:adventure).permit(:name, :description, :picture, :visit, :rating)
    end

    # def clean_adventure_params
    #   new = adventure_params["rating"] = adventure_params["rating"].to_i!
    #   adventure_params
    # end
end
